                        ...
                        <div class="body">
                            <form action="{{ route('admin.slider.update',$sliders->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" id="name" class="form-control" name="name" value="{{ $sliders->name }}">
                                        <label class="form-label">Nom image : exemple Slider_1</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" id="name" class="form-control" name="texte" value="{{ $sliders->texte }}">
                                ...
                                <a href="{{ route('admin.slider.index') }}" class="btn btn-danger m-t-15 waves-effect">ANNULER</a>
