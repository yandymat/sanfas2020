...
@section('content')
    <div class="container-fluid">
            <div class="block-header">
                <a class="btn btn-primary waves-effect" href="{{ route('auteur.post.create') }}">
                                        ...
                                        @foreach($posts as $key=>$post)
                                            <tr class="data">
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="{{ route('auteur.post.show',$post->id) }}" class="btn btn-success waves-effect">
                                                        <i class="material-icons">visibility</i>
                                                    </a>

                                                    <a href="{{ route('auteur.post.edit',$post->id) }}" class="btn btn-info waves-effect">
                                                    ...
                                                    <form id="delete-form-{{ $post->id }}" action="{{ route('auteur.post.destroy',$post->id) }}" method="POST" style="display: none;">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                </td>
