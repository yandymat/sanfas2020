...
@section('content')
        <div class="container-fluid">
            <a href="{{ route('auteur.post.index') }}" class="btn btn-danger waves-effect">Retour</a>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="card">
                            <div class="header text-center">
                                <a href="{{ route('auteur.post.edit',$post->id) }}" class="btn btn-info waves-effect"><i class="material-icons">edit</i>Modifier le post</a>
                            </div>
                        </div>
